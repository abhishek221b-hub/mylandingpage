...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <EmailIcon />, href: "mailto:abhishek221b@gmail.com", label: "Email", color: "rgba(226, 122, 60, 0.5)" },
  ...
  return (
    <footer id="footer" className="py-16 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 50% 100%, rgba(226, 122, 60, 0.05) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="container mx-auto relative z-10">
        ...
        <AnimateOnScroll className="mb-12">
          <div
            ...
            style={{
              ...
              border: ctaHovered
                ? "1px solid rgba(226, 122, 60, 0.3)"
                : "1px solid rgba(255, 255, 255, 0.08)",
              boxShadow: ctaHovered
                ? '0 0 40px rgba(226, 122, 60, 0.15)'
                : 'none',
            }}
          >
            {/* Spotlight effect */}
            <div
              ...
              style={{
                background: `radial-gradient(circle at ${mousePos.x}px ${mousePos.y}px, rgba(226, 122, 60, 0.15), transparent 40%)`,
            ...
            >
              <div
                ...
                style={{
                  background: 'linear-gradient(90deg, transparent, rgba(226, 122, 60, 0.3), rgba(251, 146, 60, 0.2), transparent)',
            ...
            <a
              href="mailto:abhishek221b@gmail.com"
              ...
              style={{
                ...
                boxShadow: ctaHovered
                  ? '0 0 30px rgba(226, 122, 60, 0.4)'
                  : '0 0 20px rgba(226, 122, 60, 0.2)',
              }}
            >
        ...
        <AnimateOnScroll delay={100}>
          ...
          >
            ...
            <div
              className="absolute top-0 left-0 h-px bg-gradient-to-r from-primary/50 via-amber-400/30 to-transparent"
              style={{ width: '200px' }}
            />
