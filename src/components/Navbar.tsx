...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['projects', 'utility', 'personal'];
  ...
  const navLinks = [
    ...
    { href: 'utility', label: 'Decision Tools' },
    { href: 'personal', label: 'Personal Builds' },
  ];
    ...
    >
      <div className="container mx-auto flex items-center justify-between py-4">
        ...
        >
          {/* Morphing indicator */}
          <div
            className="absolute -bottom-1 h-[2px] bg-gradient-to-r from-primary via-amber-400 to-orange-400 rounded-full transition-all duration-300 ease-out pointer-events-none"
            style={{
              left: indicatorStyle.left,
              width: indicatorStyle.width,
              opacity: indicatorStyle.opacity,
              boxShadow: '0 0 10px rgba(226, 122, 60, 0.5)',
            }}
          />
      ...
      {/* Progress bar */}
      <div
        className="absolute bottom-0 left-0 h-[1px] bg-gradient-to-r from-primary via-amber-400 to-orange-400 transition-all duration-150"
        style={{
